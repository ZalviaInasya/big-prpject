...
int main(){
    ...
    //melakukan scan baris per baris file.txt dan memasukkan hasil scan ke array kalimat
    ...
    //menyorting hasil token yang sudah dimasukkan ke data struct secara desc
    ...
    //mendeklarasi struct dengan array sebanyak jumlah kata untuk menampung hasil baca dari file binary
    result hasil[word];
    do{
        printf("\n\n");
        printf("[1] Masukkan Data ke File Binary\n");
